...
Line 1 of the program begins by defining a constant n at 100. n represents the maximum value that
can be seen in the array arr. This is a constraint in the problem and is a safe assumption in this context,
however this would need to be updated if the maximum number in the array arr could be greater than or equal to 100.
...
We then loop through every number in the array arr, incrementing the number of the integer key in the counts dictionary each time it is seen in the array arr.
